...
import AzurirajKnjigu from "./pages/AzurirajKnjigu";
import PopisKorisnika from "./pages/PopisKorisnika";
    ...
    <div className="App">
      <Router>
        <div className="navbar">
          ...
          {user
            ? user.administrator
              ? [
                  ...
                  <Link to="/popiskorisnika">
                    Korisnici koji nisu vratili knjigu
                  </Link>,
                ]
              : null
            : null}
          {user
            ? [
                <Link to="/details/:id_korisnika">Profil</Link>,
        ...
        <Routes>
          ...
          <Route
            path="/login"
            element={<Prijava user={user} setUser={setUser} />}
          />
          <Route
            path="/logout"
            element={<Odjava user={user} setUser={setUser} />}
          />
          ...
          <Route path="/azurirajknjigu" element={<AzurirajKnjigu />} />
          <Route path="/popiskorisnika" element={<PopisKorisnika />} />
        </Routes>
      </Router>
    </div>
  );
